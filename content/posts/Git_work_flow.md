---
title: "Git几种常见工作流"
date: 2020-04-04T21:17:49+08:00
draft: false
categories: ["Git"]
tags: ["Git"]
---
...
> **本文转自[xirong](https://github.com/xirong),已获得原作者授权,如需转载,请与原作者联系**
...
![Git Workflows](/img/GitWorkFlow/git_workflow.png)

## 2.1 集中式工作流

如果你的开发团队成员已经很熟悉`Subversion`，集中式工作流让你无需去适应一个全新流程就可以体验`Git`带来的收益。这个工作流也可以作为向更`Git`风格工作流迁移的友好过渡。
![Git Workflows: SVN-style](/img/GitWorkFlow/git-workflow-svn.png)
...
![git-workflow-svn-push-local](/img/GitWorkFlow/git-workflow-svn-push-local.png)

### 2.1.2 冲突解决

中央仓库代表了正式项目，所以提交历史应该被尊重且是稳定不变的。如果开发者本地的提交历史和中央仓库有分歧，`Git`会拒绝`push`提交否则会覆盖已经在中央库的正式提交。

![git-workflow-svn-managingconflicts](/img/GitWorkFlow/git-workflow-svn-managingconflicts.png)
...
![](/img/GitWorkFlow/git-workflow-svn-initialize.png)
...
![](/img/GitWorkFlow/git-workflow-svn-clone.png)
...
![](/img/GitWorkFlow/git-workflow-svn-1.png)
...
![](/img/GitWorkFlow/git-workflow-svn-2.png)
...
![](/img/GitWorkFlow/git-workflow-svn-3.png)
...
![](/img/GitWorkFlow/git-workflow-svn-4.png)
...
![](/img/GitWorkFlow/git-workflow-svn-5.png)
...
![](/img/GitWorkFlow/git-workflow-svn-6.png)
...
![](/img/GitWorkFlow/git-workflow-svn-7.png)
...
![](/img/GitWorkFlow/git-workflow-svn-8.png)
...
![](/img/GitWorkFlow/git-workflow-svn-9.png)
...
![Git Workflows: Feature Branch](/img/GitWorkFlow/git-workflow-feature_branch.png)

![](/img/GitWorkFlow/git-workflow-feature-branch-1.png)
...
![](/img/GitWorkFlow/git-workflow-feature-branch-2.png)
...
![](/img/GitWorkFlow/git-workflow-feature-branch-3.png)
...
![](/img/GitWorkFlow/git-workflow-feature-branch-4.png)
...
![](/img/GitWorkFlow/git-workflow-feature-branch-5.png)

小黑收到了`Pull Request`后会查看`marys-feature`的修改。决定在合并到正式项目前是否要做些修改，且通过`Pull Request`和小红来回地讨论。

#### 小红再做修改

![](/img/GitWorkFlow/git-workflow-feature-branch-6.png)
...
![](/img/GitWorkFlow/git-workflow-feature-branch-7.png)
...
![Git Workflows: Gitflow Cycle](/img/GitWorkFlow/git-workflows-gitflow.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-1historical.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-2feature.png)

注意，从各种含义和目的上来看，功能分支加上`develop`分支就是功能分支工作流的用法。但`Gitflow`工作流没有在这里止步。

### 2.3.4 发布分支

![](/img/GitWorkFlow/git-workflow-release-cycle-3release.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-4maintenance.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-5createdev.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-6maryjohnbeginnew.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-7maryfinishes.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-8maryprepsrelease.png)
...
![](/img/GitWorkFlow/git-workflow-release-cycle-9maryfinishes.png)
...
![](/img/GitWorkFlow/git-workflow-gitflow-enduserbug.png)
...
![](/img/GitWorkFlow/git-workflows-forking.png)
...
![](/img/GitWorkFlow/git-workflows-forking-1.png)
...
![](/img/GitWorkFlow/git-workflows-forking-2.png)
...
![](/img/GitWorkFlow/git-workflows-forking-3.png)
...
![](/img/GitWorkFlow/git-workflows-forking-4.png)
...
![](/img/GitWorkFlow/git-workflows-forking-5.png)
...
![](/img/GitWorkFlow/git-workflows-forking-6.png)
...
![](/img/GitWorkFlow/git-workflows-forking-7.png)
...
![](/img/GitWorkFlow/pull-request-bitbucket.png)
...
![](/img/GitWorkFlow/pull-request-overview.png)
...
![](/img/GitWorkFlow/pull-request-anatomy.png)
...
![](/img/GitWorkFlow/pull-request-feature-branch.png)
...
![](/img/GitWorkFlow/gitflow-workflow-pull-request.png)
...
![](/img/GitWorkFlow/pull-request-forking-workflow-1.png)
...
![](/img/GitWorkFlow/pull-request-forking-workflow-2.png)
...
![](/img/GitWorkFlow/pull-request-1.png)

小红先要`fork`小明的`Bitbucket`仓库，开始项目的开发。她登陆`Bitbucket`，浏览到小明的仓库页面，
点`Fork`按钮。

![](/img/GitWorkFlow/pull-request-2.png)

然后为`fork`出来的仓库填写名字和描述，这样小红就有了服务端的项目拷贝了。

#### 小红克隆她的`Bitbucket`仓库

![](/img/GitWorkFlow/pull-request-3.png)
...
![](/img/GitWorkFlow/pull-request-4.png)
...
![](/img/GitWorkFlow/pull-request-5.png)
...
![](/img/GitWorkFlow/pull-request-9.png)
...
![图片](/img/GitWorkFlow/branch_module.png)
...
![](/img/GitWorkFlow/2016-09-22-20-57-27.jpg)
...
![](/img/GitWorkFlow/2016-07-19-19-58-15.jpg)
